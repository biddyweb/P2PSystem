...
MyConductor::MyConductor(PeerConnectionClient *client):
    peer_id_(-1),
    client_(client)
{
...
void MyConductor::StartLogin(const std::string &server, int port)
{
...
void MyConductor::DisconnectFromServer()
{
    if (client_->is_connected())
        client_->SignOut();
}

void MyConductor::ConnectToPeer(int peer_id)
{
    ASSERT(peer_id_ == -1);
    ASSERT(peer_id != -1);
...
void MyConductor::DisconnectFromCurrentPeer()
{
...
void MyConductor::UIThreadCallback(int msg_id, void *data)
{
    switch (msg_id) {
...
bool MyConductor::InitializePeerConnection()
{
    IceServers servers;
    IceServer server;
...
void MyConductor::DeletePeerConnection()
{
    session_.release();
...
void MyConductor::OnSuccess(SessionDescriptionInterface *desc)
{
    LOG(INFO) << __FUNCTION__;
...
void MyConductor::OnFailure(const std::string &error)
{
...
void MyConductor::OnIceCandidate(const IceCandidateInterface *candidate)
{
...
void MyConductor::OnSignedIn()
{
    LOG(INFO) << __FUNCTION__;
    LOG(INFO) << "current id is "<<client_->id();
}

void MyConductor::OnDisconnected()
{
    LOG(INFO) << __FUNCTION__;
...
void MyConductor::OnPeerConnected(int id, const std::string &name)
{
    LOG(INFO) << __FUNCTION__;
...
void MyConductor::OnPeerDisconnected(int peer_id)
{
    LOG(INFO) << __FUNCTION__;
...
void MyConductor::OnMessageFromPeer(int peer_id, const std::string &message)
{
...
void MyConductor::OnMessageSent(int err)
{
    LOG(INFO) <<__FUNCTION__;
...
void MyConductor::OnServerConnectionFailure()
{
    LOG(INFO) <<__FUNCTION__;
}
